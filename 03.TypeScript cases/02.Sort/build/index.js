...
// 解决方法：通过继承
// 使用数值数组排序类创建数值数组排序实例
const numberCollection = new NumberCollection_1.NumberCollection([9, 5, 8, 21, 12, 2, 1]);
...
// 使用数值数组排序类创建数值数组排序实例
const characterCollection = new CharacterCollection_1.CharacterCollection("asdfih");
// 调用排序方法
